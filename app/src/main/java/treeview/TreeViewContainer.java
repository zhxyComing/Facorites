...
import treeview.cache_pool.HolderPool;
...
import treeview.listener.TreeViewNotifier;
import treeview.model.ITraversal;
import treeview.model.NodeModel;
import treeview.model.TreeModel;
import treeview.touch.DragBlock;
import treeview.util.TreeViewLog;
import treeview.util.ViewBox;
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
            ...
            if (getHit) {
                ...
                NodeModel<?> pastParentNode = null;
                if (releasedChildHolderNode.getParentNode() != null) {
                    pastParentNode = releasedChildHolderNode.getParentNode();
                ...
                requestLayout();
                controlListener.onDragOver(releasedChildHolderNode, targetHolderNode, pastParentNode);
            } else {
                //recover
